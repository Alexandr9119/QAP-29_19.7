...
def test_create_pet_simple(name='Собачка', animal_type='dog', age='4'):
...
def test_create_pet_with_photo(name='Оливье', animal_type="собак", age='5', photo='images/dog2.jpg'):
...
def test_update_pet(name='Собак', animal_type='dog', age='0.8'):
...
def test_add_pet_photo(photo='images/Dog1.jpg'):
...
def test_failed_delete_pet_with_wrong_id():
    ...
    if len(my_pets['pets']) == 0:
        pf.create_pet_with_photo(auth_key, "Бесяка", "собакен", "2", "images/dog1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
    pet_id = 10000000000
